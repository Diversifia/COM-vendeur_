...
const AnalyticsDashboard: React.FC<AnalyticsDashboardProps> = ({ allAgentsData }) => {
  ...
  // Prepare Data for Sales Mix (Aggregated)
  let salesMix = {
    Internet: 0,
    Mobile: 0,
    Box: 0
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      {/* NEW: Objectives vs Realization Chart */}
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div className="mb-6 flex justify-between items-end">
          <div>
            <h3 className="text-lg font-bold text-gray-800">Objectifs vs Réalisations (Nov 2025)</h3>
            <p className="text-sm text-gray-500">Suivi du volume total de ventes et du Taux de Réalisation (TRO)</p>
          </div>
        </div>
        <div className="h-80 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <ComposedChart data={objectivesData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500">Comparaison des revenus nets après déductions</p>
        </div>
        <div className="h-80 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={comparisonData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
              ...
              <YAxis />
              <Tooltip 
                formatter={(value: number) => new Intl.NumberFormat('fr-MA', { style: 'currency', currency: 'MAD', maximumFractionDigits: 0 }).format(value)}
                contentStyle={{ borderRadius: '8px', border: 'none', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }}
              />
              <Legend />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
           <div className="mb-6">
            ...
            <p className="text-sm text-gray-500">Top 5 Vendeurs (Volume Commissions)</p>
          </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
           <div className="mb-6">
            ...
            <p className="text-sm text-gray-500">Répartition des ventes totales de l'équipe</p>
          </div>
